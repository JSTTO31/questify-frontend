<template>
  <v-navigation-drawer width="310" permanent>
    <v-layout class="w-100 h-100">
      ...
      <v-main class="h-100">
        <v-list
          ...
          :class="isDragover ? 'bg-grey-lighten-2' : ''"
          @click="selected = []"
        >
          <div v-for="(question, n) in questions" :key="question">
            <QuestionListItem
